...
// import co.edu.unipiloto.myapplication.adapters.PendingRequestsAdapter;
...
public class PendingRequestsFragment extends Fragment {
    ...
    // private List<Solicitud> pendingList;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // Asume que el layout para esta pestaña se llama fragment_pending_requests.xml
    ...
    private void setupRecyclerView() {
        ...
        // adapter = new PendingRequestsAdapter(getContext(), pendingList);
        // recyclerView.setAdapter(adapter);
    }

    private void loadPendingRequests() {
        // 🛑 Lógica de datos: Obtener solicitudes con estado PENDIENTE.
        // Ejemplo: CallToRepository.getPendingRequests((list) -> {
        //     pendingList.clear();
